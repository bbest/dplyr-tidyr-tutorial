...
```{r}
plyr::ldply(food) %>% head

# OR without plyr
food %>% lapply(as.data.frame) %>% rbind_all() %>% head
```
...
system.time({ #time the basic version
